...
public class RechercheS extends Activity implements View.OnTouchListener, View.OnClickListener{
		...
		String message;
		  ...
		  protected void onCreate(Bundle savedInstanceState) {
	       ...
	       // je recupère de l'autre activity le nombre de contact
	       ...
	       buttonsuiv.setOnClickListener(new View.OnClickListener() {
	          ...
	          public void onClick(View v) {
				...
				// Si le truc tapé n'est pas dans le repertoire. 
				if(a == 0)
				{
					Context context = getApplicationContext();
					...
					// envoie le numéro id a l'autre activité, ainsi que le nombre de contact.
...
/////////////////////////////////////////FIN BOUTON et CLICK///////////////////////////////////////////////////////////////////////////////////////////////
		   ...
		   critere1.addTextChangedListener(textWatcher);  // si on tape*/
		    ...
		    // je récupère tous les noms et je les mets dans un tableau, et ensuite les affiche dans une listeview
		     String s ;
         ...
         lv.setOnItemClickListener(new OnItemClickListener() {
		  ...
		  //quand on tape dans la bar de recherche
	   private TextWatcher textWatcher = new TextWatcher() {
		...
		// actionbar avec bouton retour
		  ...
		  // si on click sur le bouton retour de l'actionbar
		  @Override
